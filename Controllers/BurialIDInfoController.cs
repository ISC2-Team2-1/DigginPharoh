...
{
    public class BurialIDInfoController : Controller
    {
        private readonly ApplicationDbContext _context;

        public BurialIDInfoController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        // GET: BurialIDInfo/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: BurialIDInfo/Create
